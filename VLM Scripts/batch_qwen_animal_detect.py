...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description="Run Qwen2.5-VL animal detection over nested camera-trap folders and save CSV results."
    )
    parser.add_argument(
        "--input-dir",
    ...
    parser.add_argument(
        "--output-csv",
        default="/storage/ice-shared/cs8903onl/Mcquire-animal-detection/stonemt_cameratrap/Camera Trap Photos/Processed_Images/qwen_animal_detection_results.csv",
